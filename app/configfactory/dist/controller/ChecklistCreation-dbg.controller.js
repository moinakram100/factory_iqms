sap.ui.define(
    ...
    function (BaseController, JSONModel, helperFunctions) {
      ...
      return BaseController.extend("com.ingenx.qms.configfactory.controller.ChecklistCreation", {
        onInit: function () {
          oView = this.getView();
        ...
        onCreate: function () {
          helperFunctions._openValueHelpDialog(this, 'CheckCre_Dialog', 'com.ingenx.qms.configfactory.fragments.ChecklistCreation');
  
        },
  
  
        onVehicleType: function () {
          helperFunctions._openValueHelpDialog(this, 'VehicleDialog', 'com.ingenx.qms.configfactory.fragments.Vehicle');
