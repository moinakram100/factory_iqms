sap.ui.define([
    ...
    function (Controller, JSONModel, Fragment, ODataModel, helperFunctions) {
      ...
      return Controller.extend("com.ingenx.qms.configfactory.controller.MaterialDefinition", {
        ...
        onAddBtnPress: function () {
          ...
          helperFunctions._openValueHelpDialog(this, "addMaterialDialog", "com.ingenx.qms.configfactory.fragments.AddMaterialType");
        ...
        onMaterialValueHelp: function (oEvent) {
          helperFunctions._openValueHelpDialog(this, 'MaterialTypeDialog', 'com.ingenx.qms.configfactory.fragments.MaterialType')
