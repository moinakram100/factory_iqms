sap.ui.define([
    ...
    function (Controller, JSONModel, Fragment, helperFunctions) {
      ...
      return Controller.extend("com.ingenx.qms.configfactory.controller.VehicleDefinition", {
        ...
        onCreateVehicle: function () {
          ...
          if (!this.openVehicleDailog) {
            this.openVehicleDailog = sap.ui.xmlfragment("com.ingenx.qms.configfactory.fragments.AddVehicleType", this);
        ...
        valueHelpVehicleType: function (oEvent) {
          ...
          helperFunctions._openValueHelpDialog(this, 'VehicleTypeDialog', 'com.ingenx.qms.configfactory.fragments.VehicleType');
