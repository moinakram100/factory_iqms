...
sap.ui.define([
    ...
    "sap/m/MessageBox",
   "com/ingenx/qms/configfactory/utils/helperFunctions"
],
    /**
    ...
    function (Controller, MessageBox, helperFunctions) {
        ...
        return Controller.extend("com.ingenx.qms.configfactory.controller.ParkingGate", {
            onInit: function () {
            ...
            onAddParkingGate: function () {
                helperFunctions._openValueHelpDialog(this, 'addParkingGate_dialog', 'com.ingenx.qms.configfactory.fragments.AddParkingGate');
            ...
            onAddParkingArea: function () {
                ...
                helperFunctions._openValueHelpDialog(this, 'addParkingArea_dialog', 'com.ingenx.qms.configfactory.fragments.AddParkingArea');
