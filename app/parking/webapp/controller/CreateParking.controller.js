  ...
  function (Element,Controller,MessageBox,Filter,FilterOperator,MaterialType,helperFunctions, MessageToast) {
    ...
    return Controller.extend("com.ingenx.qms.parking.controller.CreateParking", {
      ...
      createParkingFn: async function (parkingData) {
        let {parkingGate, parkingArea, createdDate, vehicleNumber, driverName, cleanerName, sSelectedText, TransportCode, customerCode, product, VehicleType, parkStatus, plant, plantText,stausNum} = parkingData
        try {
          let now = new Date();
      ...
      onScanSuccess: async function (oEvent) {
        ...
        if (oEvent.getParameter("cancelled")) {
          ...
          if (scanResult) {          
            ...
            this.createdTime = scannedData.createdTime
            this.material = scannedData.material
