sap.ui.define(
    ...
    function (BaseController, Filter, FilterType, FilterOperator, MessageBox) {
      ...
      return BaseController.extend("com.ingenx.qms.parkingfactory.controller.VehicleChecklist", {
        onInit() {
          ...
          oRouter.getRoute("RouteVehicleChecklist").attachPatternMatched(this.onObjectMatched, this);
        },
