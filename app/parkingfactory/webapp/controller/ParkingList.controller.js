...
sap.ui.define(
    ...
    function (BaseController, Filter, FilterType, FilterOperator, MessageBox) {
      ...
      return BaseController.extend("com.ingenx.qms.parkingfactory.controller.ParkingList", {
        ...
        onInit: async function () {
          ...
          oRouter.getRoute('RouteParkinglist').attachPatternMatched(this.onObjectMatched, this);
