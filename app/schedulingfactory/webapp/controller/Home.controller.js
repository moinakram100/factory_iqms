...
sap.ui.define([
	...
	"sap/ui/core/Core",
	"sap/m/MessageBox",
	"com/ingenx/qms/schedulingfactory/utils/helperFunctions"
	...
	function (coreLibrary, Fragment, Controller, DateFormat, JSONModel, unifiedLibrary, mobileLibrary, MessageToast, UI5Date, Core, MessageBox, helperFunctions) {
		...
		return Controller.extend("com.ingenx.qms.schedulingfactory.controller.Home", {
			...
			onPlantCode: function () {
				helperFunctions._openValueHelpDialog(this, 'PlantCodeDialog', 'com.ingenx.qms.schedulingfactory.fragments.PlantCode');
			...
			onCustomerCode: function () {
				helperFunctions._openValueHelpDialog(this, 'CustomerCodeDialog', 'com.ingenx.qms.schedulingfactory.fragments.CustomerCode');
			...
			_arrangeDialogFragment: function () {
				...
				if (!this._pNewAppointmentDialog) {
					this._pNewAppointmentDialog = Fragment.load({
						id: oView.getId(),
						name: "com.ingenx.qms.schedulingfactory.fragments.Modify",
						controller: this
			...
			handleAppointmentSelect: function (oEvent) {
				...
				if (!this._pDetailsPopover) {
					this._pDetailsPopover = Fragment.load({
						id: oView.getId(),
						name: "com.ingenx.qms.schedulingfactory.fragments.Details",
						controller: this
