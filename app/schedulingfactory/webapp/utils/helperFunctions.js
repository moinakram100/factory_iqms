sap.ui.define(["sap/ui/core/Fragment","sap/ui/model/Filter","sap/ui/model/FilterOperator"],
   ...
   return {
    ...
    // modified by deepanshu also worked for single value without array
    _valueHelpLiveSearchMutipleFilters: function (oEvent, filterFields, bAndCondition) {
        ...
        // If a single field (string) is passed, convert it to an array
        ...
        if (sValue) {
            ...
            // Combine them with OR (if bAndCondition is false) or AND (if bAndCondition is true)
