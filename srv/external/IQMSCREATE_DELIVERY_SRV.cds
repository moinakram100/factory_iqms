/* checksum : b458640adf2d46dcc325affb41cee8f9 */
@cds.external : true
@m.IsDefaultEntityContainer : 'true'
@sap.supported.formats : 'atom json xlsx'
service IQMSCREATE_DELIVERY_SRV {};
...
entity IQMSCREATE_DELIVERY_SRV.delivery_createSet {
  @sap.unicode : 'false'
  @sap.label : 'Delivery'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  ...
  del_nav_return : Association to many IQMSCREATE_DELIVERY_SRV.delivery_returnSet {  };
  del_nav_items : Association to many IQMSCREATE_DELIVERY_SRV.Sales_orderItemsSet {  };
};
...
@sap.pageable : 'false'
@sap.content.version : '1'
entity IQMSCREATE_DELIVERY_SRV.Sales_orderItemsSet {
  @sap.unicode : 'false'
...
@sap.pageable : 'false'
@sap.content.version : '1'
entity IQMSCREATE_DELIVERY_SRV.delivery_returnSet {
  @sap.unicode : 'false'
